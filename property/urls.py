...
from .views import (
    ...
    DeleteDocumentView,
    GetPieChartView,
    PropertyExportAPIView,
    FolderViewset,
)

router = DefaultRouter()
router.register(
    r"property/(?P<property_id>\d+)/folder", FolderViewset, basename="property-folder"
)
...
urlpatterns = [
    ...
    path(
        "property/<int:folder_id>/document/",
        PropertyDocumentView.as_view(),
        name="property-documents",
    ),
    path(
        "property/<int:folder_id>/document-delete/<int:document_id>/",
        DeleteDocumentView.as_view(),
        name="property-documents-delete",
    ),
